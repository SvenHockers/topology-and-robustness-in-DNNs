...
def compute_gaussian_weights(
    ...
    """
    Compute Gaussian edge weights from distances.
    
    Args:
        distances: Distance matrix or array
        sigma: Scale parameter for Gaussian kernel
        
    Returns:
        Weight matrix or array
    """
...
def compute_laplacian(
    ...
    Args:
        W: Weight matrix (adjacency)
        normalized: If True, compute normalized Laplacian; else unnormalized
...
def compute_graph_scores(
    ...
    """
    from .models import get_model_logits, get_model_predictions, extract_features_batch
    ...
    if graph_params.use_diffusion:
        ...
        eigenvalues, eigenvectors = compute_diffusion_embedding(
